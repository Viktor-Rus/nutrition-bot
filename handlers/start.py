...
def start_welcome_text():
    return (
        "Привет! Я MealAdvisor — твой личный помощник по питанию.\n\n"
        "Помогаю без жёстких запретов: разбираю фото еды и составы продуктов, "
        "подбираю рецепты и даю советы под твою цель.\n\n"
        "🎯 Хочешь советы точнее?\n"
        "Нажми «Настроить под себя» и добавь:\n"
        "• возраст, рост и вес\n"
        "• цель: похудеть, набрать массу или питаться лучше\n"
        "• предпочтения, аллергии и ограничения\n\n"
        "Можно начать проще: пришли фото еды или упаковки."
    )
