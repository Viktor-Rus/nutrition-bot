...
FOOD_ANALYSIS_FORMAT_INSTRUCTION = (
    ...
    "Перед оценкой обязательно сверь блюдо с долговременной памятью пользователя. Если в блюде "
    "есть продукт, который пользователь не ест, не переносит или отметил как ограничение, "
    "коротко укажи персональный конфликт и предложи замену. Не называй этот продукт плюсом "
    "и не советуй увеличивать его количество. "
                ...
                "content": [
                    {
                        ...
                        "text": (
                            ...
                            "Перед финальным ответом обязательно сверь видимые ингредиенты с долговременной "
                            "памятью пользователя. Если на фото виден продукт, который пользователь не ест, "
                            "не переносит или отметил как ограничение, прямо укажи это как персональный конфликт "
                            "и предложи простую замену. Такой продукт нельзя записывать в плюсы блюда для "
                            "этого пользователя. "
                            "Не считай калории и БЖУ, если пользователь прямо не просит. "
